...
private:
    ...
    static void thomson_draw(TMultiGraph *mg, const SignalProcessing &sp, uint nPoints, const int integrate, bool draw=true, bool drawSigBox=false, const std::vector<TString> &gTitle={}, const barray &work_mask={}, double scale=1., bool drawTimePoints=false, int channel=-1);
...
public:
    ...
    static void thomson_signal_draw(TCanvas *c, TMultiGraph *mg, SignalProcessing *sp, int integrate=0, bool draw=true, bool drawLegend=true, bool drawSigBox=false, uint NChannels=6, const barray &work_mask={}, double scale=1., bool title=true, bool drawTimePoint = true, int channel=-1);
